...
const RIFT_DATA = {
    ...
    characters: [
        ...
        },
        {
            ...
            firstChapter: 5,
            tags: ["Flame Aspect", "Nephilim", "Swordsman"],
            abilities: [
    ...
    chapterEvents: [
        ...
        { ch: 10, type: "event", spoiler: 3, text: "Realizing the other slaves are a liability, Sunny poisons their water supply to survive the Mountain King's tracking." },
        ...
        { ch: 16, type: "powerup", spoiler: 2, text: "Receives Divine Aspect: Shadow Slave and True Name: Lost from Light.", powerDetail: "Unlocks Shadow Control and a Shadow Core." },
        ...
        { ch: 17, type: "event", spoiler: 1, text: "Sunny awakens in the waking world as a Sleeper and is discovered by Master Jet." },
        ...
        { ch: 60, type: "lore", spoiler: 2, text: "The Crimson Sea is revealed.", loreDetail: "Sunny discovers that when the sun sets, a terrifying black sea rises to drown the labyrinth, forcing him to seek high ground." },
        ...
        { ch: 480, type: "lore", spoiler: 2, text: "The Sun God and the Demon of Desire.", loreDetail: "Sunny uncovers the deep lore of the region. He learns about Noctis, the Sun God, and the Ivory Tower where Hope (the Demon of Desire) is imprisoned." },
        ...
        { ch: 530, type: "lore", spoiler: 3, text: "Mordret's terrifying power revealed.", loreDetail: "Mordret's abilities relate to mirrors and souls. He is a dangerous Awakened capable of possessing other people's bodies and stealing their identities." },
        ...
        { ch: 1610, type: "lore", spoiler: 2, text: "A New Beginning.", loreDetail: "Adapting to his heartbreaking new reality, Sunny opens a humble cafe and shop, operating from the shadows while independently planning his next moves." },
        ...
        { ch: 1920, type: "event", spoiler: 2, text: "Guiding the Rain.", textDetail: "Amidst the chaos of total war, Sunny continues his complicated dance with his former allies while focusing on the growth and survival of his disciple, Rain." },
        { ch: 1950, type: "event", spoiler: 3, text: "Human Beasts.", textDetail: "Intense battlefield sequences reveal the grim reality of 'Human Beasts', underscoring the deeply dehumanizing and horrific nature of the escalating Domain War." },
        { ch: 1980, type: "event", spoiler: 3, text: "The Siege of Bastion.", textDetail: "The conflict reaches a devastating boiling point as the major powers clash directly at Bastion, resulting in massive casualties and shifting the entire landscape of the war." },
        { ch: 2000, type: "event", spoiler: 3, text: "A Shift in Power.", textDetail: "A monumental milestone in the story. Various plot threads of the Domain War culminate, resulting in a massive shift in the balance of power and setting the stage for the endgame." }
    ]
};
